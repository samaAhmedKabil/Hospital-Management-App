...
import com.example.hospitalapplication.databinding.LayoutMedicalRecordBinding
import com.example.hospitalapplication.models.ModelCreation
import com.example.hospitalapplication.network.NetworkState
import com.example.hospitalapplication.ui.doctor.MedicalMeasurement.MedicalMeasurementFragmentDirections
import com.example.hospitalapplication.ui.doctor.MedicalMeasurement.MedicalMeasurementViewModel
...
class MedicalRecordFragment:Fragment() {
    private var _binding: LayoutMedicalRecordBinding?= null
    ...
    private val medicalMeasurementViewModel  : MedicalRecordViewModel by viewModels()
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.layout_medical_record , container , false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = LayoutMedicalRecordBinding.bind(view)
    ...
    private fun sendClick(){
        ...
        binding.addAnalyst.setOnClickListener {
            findNavController().navigate(MedicalRecordFragmentDirections.actionMedicalRecordFragmentToSelectDoctorFragment(Const.ANALYSIS))
        }
    }
}